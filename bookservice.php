...
<div class="sidebar">
  <a class="active" href="bookservice.php">Book a Service</a>
  ...
  <section id="adminform" class="section_class">
    <div class="col-sm-12">
      <div class="col-sm-6">
          ...
          <div class="admin_tick" style="text-align: left;margin-bottom: 20px;">
            ...
            <?php
              ...
              $check->execute();
              if($check->rowcount()==0){
                echo 'No services available!!!'; //->> 0 for account does not exist
              }
      ...
      <div class="col-sm-6">
          ...
          <div class="admin_tick" style="text-align: left;margin-bottom: 20px;">
            <div class="admin_heading" style="margin-bottom: 20px;">
              <h1 style="text-align: center;">Book A Service</h1>
            </div>
            <form id="adminform">
              ...
              <div class="form-group">
                <input type="text" id="placeid" placeholder="Place/City id" class="form-control" required>
              </div>
              <div class="form-group">
                <input type="text" id="serviceid" placeholder="Service id" class="form-control" required>
              </div>
              <div class="form-group">
...
>>>>>>> 12d071b64040732659b7df9d40f4c50586a56153
</html>