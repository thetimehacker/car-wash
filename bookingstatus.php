...
<div class="sidebar">
  <a href="bookservice.php">Book a Service</a>
  <a class="active" href="bookingstatus.php">Booking Status</a>
    ...
    <div class="col-sm-6">
        ...
        <div class="add_club_coordinator" style="margin-bottom: 20px;">
          <div class="admin_heading">
            <h1 style="text-align: center;">No Bookings to Show Status!!!</h1>
          </div>
        ...
        <?php
          ...
          if($check->rowcount()==0){
            ...
            while($datarow=$check->fetch()){
              ...
              <tr>
                  <td><center><?php echo $datarow['bid'] ?></center></td>
                  ...
                  <td>
                    ...
                    <?php
                     ...
                     <button 
                      ...
                      padding: 0px 10px;
                      color: white;
                      margin: 10px;">Cancelled/Rejected</button>
      ...
      $.ajax(
      {
        ...
        success:function(data){
          if(data==0){
            ...
            open("bookingstatus.php","_self"); //refresh the page
